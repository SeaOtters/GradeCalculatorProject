...
function calculateGrade(){
    var totalWeight = parseInt(document.getElementById("homeworkWeight").value) + parseInt(document.getElementById("classworkWeight").value) + parseInt(document.getElementById("assessmentWeight").value) + parseInt(document.getElementById("participationWeight").value) + parseInt(document.getElementById("projectWeight").value);
    ...
    var projectAverage = calculateCatGrade("project");
    var projectTotal= calculateWeight(projectAverage, "project");
    ...
    currentGrade = homeworkTotal + classworkTotal + assessmentTotal + participationTotal + projectTotal;
